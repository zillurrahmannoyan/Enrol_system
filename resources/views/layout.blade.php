  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('/admin-dashboard')}}"><img src="" alt="Logo"></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
              <img src="{{URL::to('image/zillur.png')}}" alt="">
            </div>
            <div class="details">
              <p class="user-name">Zillur Rahman</p>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="uiAdvancedSubmenu">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/mba_teacher')}}">MBA</a>
                  </li> --}}
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="float-right">
                <a href="#">Zillur Rahman</a> &copy; 2018
            </span>
          </div>
        </footer>
        <!-- partial -->
